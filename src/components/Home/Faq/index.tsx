...
const faqData = [
  {
    question: "What is NexoraPay?",
    answer:
      "NexoraPay is a cryptocurrency exchange that allows users to trade 100+ cryptocurrencies worldwide.",
  },
  {
    question: "Is NexoraPay available worldwide?",
    answer: "Yes, NexoraPay is accessible from most countries around the globe.",
  },
  {
    question: "Which cryptocurrencies are supported on NexoraPay?",
    answer:
      "We support Bitcoin, Ethereum, Litecoin, and many more. Over 100 cryptocurrencies are available.",
  },
  {
    question: "Is my personal information secure with NexoraPay?",
    answer:
  ...
  {
    question: "Does NexoraPay offer advanced trading tools?",
    answer:
      "Yes, NexoraPay provides charts, APIs, and tools suitable for both beginners and professionals.",
  },
];
