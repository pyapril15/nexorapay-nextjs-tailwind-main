      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4 relative">
          <div
            ...
            className="cursor-pointer text-white bg-transparent border border-border rounded-md px-3 py-2 text-start"
          >
            {formData.name}
          </div>
          {isDropdownOpen && (
            <div className="absolute z-10 bg-dark border border-border mt-1 rounded-md w-full">
              {cryptos.map((crypto) => (
                <div
                  key={crypto.name}
        ...
        <div className="mb-4">
          <Input
            ...
            type="text"
            name="price"
            className="text-white bg-transparent border border-border rounded-md px-3 py-2 h-auto w-full focus:border-primary focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:shadow-none"
        ...
        <Button
          type="submit"
          disabled={loading}
          className="text-background font-medium text-lg bg-primary w-full border border-primary rounded-lg py-6 hover:text-primary hover:bg-transparent transition-all duration-300"
        >
